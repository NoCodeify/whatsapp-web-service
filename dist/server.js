...
if (process.env.BRIGHT_DATA_PROXY_TYPE === "isp") {
  ...
  sessionRecoveryService = new SessionRecoveryService_1.SessionRecoveryService(
    firestore,
    dynamicProxyService,
...
const connectionStateManager =
  new connectionStateManager_1.ConnectionStateManager(firestore);
// Initialize reconnection service
const reconnectionService = new ReconnectionService_1.ReconnectionService(
  sessionManager,
  undefined, // Will be set after connectionPool is created
  firestore,
);
