...
export declare class MediaService {
     ...
     */
    uploadMedia(file: MediaFile, userId: string, phoneNumber: string): Promise<MediaUploadResult>;
    /**
     * Download media from WhatsApp and upload to Cloud Storage
     */
    downloadAndUploadWhatsAppMedia(downloadFunction: () => Promise<Buffer>, mimetype: string, userId: string, phoneNumber: string): Promise<MediaUploadResult>;
    /**
