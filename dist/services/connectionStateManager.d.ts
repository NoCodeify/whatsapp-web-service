...
export declare class ConnectionStateManager extends EventEmitter {
     ...
     */
    initializeState(userId: string, phoneNumber: string, instanceUrl: string): Promise<ConnectionState>;
    /**
     * Update connection state
     */
    updateState(userId: string, phoneNumber: string, updates: Partial<ConnectionState>): Promise<ConnectionState | null>;
    /**
     * Get connection state
     */
    getState(userId: string, phoneNumber: string): Promise<ConnectionState | null>;
    /**
     ...
     */
    markDisconnected(userId: string, phoneNumber: string, reason?: string): Promise<void>;
    /**
     ...
     */
    updateSyncProgress(userId: string, phoneNumber: string, contacts: number, messages: number, completed?: boolean): Promise<void>;
    /**
