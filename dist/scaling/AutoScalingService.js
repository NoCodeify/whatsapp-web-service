...
const logger = (0, pino_1.default)({ name: "AutoScalingService" });
class AutoScalingService {
     ...
     */
    shouldScaleUp(connectionLoad, memoryLoad) {
     ...
     */
    async shouldScaleDown(connectionLoad, memoryLoad) {
     ...
     */
    async updateCloudRunInstances(targetInstances) {
     ...
     */
    async recordScalingAction(action, fromInstances, toInstances, metrics) {
        try {
