...
const CloudRunSessionOptimizer_1 = require("../services/CloudRunSessionOptimizer");
    ...
    constructor(proxyManager, firestore) {
        ...
        if (this.storageType === "hybrid" || this.storageType === "cloud") {
            ...
            if (this.storageType === "cloud") {
                this.cloudOptimizer = new CloudRunSessionOptimizer_1.CloudRunSessionOptimizer(this.storage, this.firestore);
