import { WASocket, ConnectionState, WAMessageContent, WAMessageKey } from "@whiskeysockets/baileys";
...
export declare class ConnectionPool extends EventEmitter {
    ...
    constructor(proxyManager: ProxyManager, sessionManager: SessionManager, firestore: Firestore, pubsub: PubSub, connectionStateManager?: ConnectionStateManager);
    /**
     * Setup WebSocket manager event listeners
     */
    private setupWebSocketManagerListeners;
    /**
     ...
     */
    private setupInstanceCoordinatorListeners;
    /**
     ...
     */
    addConnection(userId: string, phoneNumber: string, proxyCountry?: string, countryCode?: string, isRecovery?: boolean, browserName?: string): Promise<boolean>;
    /**
     ...
     */
    sendMessage(userId: string, phoneNumber: string, toNumber: string, content: WAMessageContent): Promise<WAMessageKey | null>;
    /**
    ...
    private getContainerMemoryLimit;
