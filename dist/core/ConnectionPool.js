    ...
    setupConnectionHandlers(connection) {
        ...
        socket.ev.on("connection.update", async (update) => {
            ...
            if (state === "close") {
                ...
                if (shouldReconnect) {
                    this.logger.info({ userId, phoneNumber, disconnectReason }, "Connection closed, attempting reconnect");
        ...
        try {
            ...
            for (const chat of chats) {
                ...
                if (!existingContacts.empty) {
                    ...
                    if ((!existingData.first_name || existingData.first_name === "Unknown" || existingData.first_name === "") &&
                        firstName !== "Unknown") {
                        updateData.first_name = firstName;
                    }
                    if ((!existingData.last_name || existingData.last_name === "Unknown" || existingData.last_name === "") &&
                        lastName !== "Unknown") {
